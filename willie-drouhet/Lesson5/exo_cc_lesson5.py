...
#--> forme galenique / mass / pourcentage / marque / etc.
...
#iburpofene
#ebotiroxine
#dosage forme galenique

#antarene teva sante

#list_medoc=["levothyroxine"]
...
for page in range(3):
    ...
    for row in rows:
        ...
        try:
            ...
            medicament = (data_medic[0][0] + ' ' + data_medic[0][3]).replace('IBUPROFENE','').strip()
...
df = pd.DataFrame(medicaments, columns=['Marque', 'Dose', 'Unite', 'Type'])
print df
