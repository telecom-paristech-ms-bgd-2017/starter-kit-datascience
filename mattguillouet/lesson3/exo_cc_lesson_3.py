...
def allDiscounts(brand, nbPage):
	...
	for page in range(1, nbPage + 1):
		print('process page {0}/{1} for brand {2}'.format(page, nbPage, brand), end='\r')
		getDict = {'TechnicalForm.SiteMapNodeId':'0', 'TechnicalForm.DepartmentId':'10', 'hdnPageType':'Search', 'TechnicalForm.PageType':'SEARCH_AJAX', 'TechnicalForm.LazyLoading.ProductSheets':'False',
					'NavigationForm.CurrentSelectedNavigationPath':'0', 'ProductListTechnicalForm.Keyword': brand, 'page':page}
